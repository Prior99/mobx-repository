...
describe("SegmentWithIds", () => {
    ...
    describe("`combine`", () => {
        it.each([
            ...
            {
                given: [new SegmentWithIds(10, new Set([110])), new SegmentWithIds(11, new Set([111]))],
            ...
            {
                given: [new SegmentWithIds(10, new Set([110])), new SegmentWithIds(10, new Set([110]))],
                expected: new SegmentWithIds(10, new Set([110])),
            },
        ])(
            "test set %#",
...
describe("`tidySegments`", () => {
    it.each([
        ...
        {
            given: [new SegmentWithIds(10, new Set([110]))],
            expected: [new SegmentWithIds(10, new Set([110]))],
        },
        {
            given: [
